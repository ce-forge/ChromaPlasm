...
class LiveRenderer:
    ...
    def draw(self, screen, sim, vfx_manager, viewport, show_pheromones, 
        ...
        top_margin_rect = pygame.Rect(0, 0, VIDEO_WIDTH, VIDEO_TOP_MARGIN); bottom_margin_rect = pygame.Rect(0, VIDEO_HEIGHT - VIDEO_BOTTOM_MARGIN, VIDEO_WIDTH, VIDEO_BOTTOM_MARGIN)
        margin_color = (16, 16, 26, 220)
        pygame.draw.rect(final_render_surface, margin_color, top_margin_rect); pygame.draw.rect(final_render_surface, margin_color, bottom_margin_rect)
        ...
        try:
            font_scale = VIDEO_HEIGHT / 1920.0; title_font_size = int(self.base_font_size * font_scale * 0.6)
